      ...
      <div className="contact-container">
            ...
            >
              <div className="form-control first-name">
                ...
                <input className="input-box" name="firstName" id="first-name" type="text" />
              </div>

              <div className="form-control last-name">
                <label htmlFor="last-name">Last Name</label>
                <input className="input-box" name="lastName" id="last-name" type="text" />
              </div>

              <div className="form-control email">
                <label htmlFor="email">Email *</label>
                <input className="input-box" name="email" id="email" type="email" required />
